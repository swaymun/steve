...
The [v0.1.5 development preview](https://github.com/swaymun/steve/releases/tag/v0.1.5) contains a Developer ID-signed, Apple-notarized app for **Apple silicon (arm64), macOS 14 or later**. Native Computer Use has separate availability and macOS requirements; inspect its installed app and supported Codex setup flow. Intel builds have not been validated.
...
For this version: [download the app ZIP](https://github.com/swaymun/steve/releases/download/v0.1.5/Steve-macOS.zip) and [its checksum](https://github.com/swaymun/steve/releases/download/v0.1.5/Steve-macOS.zip.sha256). In the download folder:
