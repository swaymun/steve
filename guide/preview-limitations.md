...
- **One visible Mac at a time:** research tasks can overlap, but workers take turns controlling the shared desktop and browser. Native helpers handle public research only and require compatible Codex support; workers work alone when helpers are unavailable.
